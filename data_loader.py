...
class MyDataset(torch_dataset):
    ...
    def __getitem__(self, idx):
        ...
        return I, label
#%%
def get_dataloader(path = "/Users/annikamurray/Desktop/UM_ML/Assignment 05/hw5s/S224/" ):    
    ...
    loader_train = torch_dataloader(dataset_train, batch_size=32, num_workers=2, shuffle=True, pin_memory=True)
    loader_val = torch_dataloader(dataset_val, batch_size=32, num_workers=2, shuffle=True, pin_memory=True)
    loader_test = torch_dataloader(dataset_test, batch_size=32, num_workers=2, shuffle=True, pin_memory=True)

    #modify this function to return loader_train, loader_val, and loader_test
    return dataset_train, loader_train, loader_val, loader_test